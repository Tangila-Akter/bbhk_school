  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      <div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Add Staffs Documents</h5>
        ...
        <br>
        <!--Notice View start-->
        <form action="{{ url('staffssearch') }}" method="get" class="form-inline" style="float:right; padding:10px; color:rgb(255, 255, 255);">
          @csrf
        ...
        <table class="id01 table" style="margin-top: 8rem;">
          ...
          <tbody>
            <tr style="background-color: #ffffff; color:black;" class="item">
              ...
              <td>{{ $data->date }}</td>
              <td>{{ $data->image }}</td>
              <td><a class="btn btn-warning" href="{{ url('/deletestaffs',$data->id) }}">Delete</a>&nbsp<a class="btn btn-primary" href="{{ url('/updatestaffs',$data->id) }}">Edit</a></td>
            </tr>
          </tbody>
          @endforeach
