...
class AdminController extends Controller
{
    ...
    public function admin_result_back()
    {
        $data = result::all();
        return view('admin.result', compact("data"));
    }
    ...
    public function uploadresult(Request $request)
    {
        ...
        $image = $request->image;
        $imagename = time() . '.' . $image->getClientOriginalExtension();
        $request->image->move('result', $imagename);
        $data->image = $imagename;
        $data->title = $request->title;
        $data->date = $request->date;
    ...
    {
        $data = result::find($id);
        return view("admin.updateresult", compact("data"));
    }
    ...
    public function admin_gallary()
    {
        $data = gallary::where('usertype', '0')->get();
        return view('admin.admin_gallary', compact("data"));
    }
