...
<html lang="en">
  ...
  <body>
    ...
    <div style="position: relative; top:60px; right:-150px;">
      <h1>Update Exam Routine</h1>
      <form action="{{ url('/update_exam',$data->id) }}" method="post" enctype="multipart/form-data">
        @csrf
       ...
       <div>
        <div>
          ...
          <img height="200" width="200" src="exam/{{ $data->image }}" hidden >
      </div>
            <div>
